...
Deepgram best practices require that all audio files be reviewed by four independent users. Hotpepper implements the idea of independent reviewers through the concept of levels, each of which represents a queue of unlabeled files that require different levels of effort. To learn more about Deepgram’s suggested ordering of operations, visit [Understanding the Workflow](/data-labeling-understanding-the-workflow).
