...
| :---------------------------------------------------------------- | :------------------------------ | :----------------------------------------------------------------------------------------- |
| [Aura](/tts-feature-overview) | Starting at 2400 requests / min | [Share your feedback on our TTS rate limits](https://deepgram.typeform.com/tts-rate-limit) |

### Text to Speech Streaming

| Model                                                                       | Service Limit                       | Feedback                                                                                   |
| :-------------------------------------------------------------------------- | :---------------------------------- | :----------------------------------------------------------------------------------------- |
| [Aura](/tts-streaming-feature-overview) | Starting at 150 concurrent requests | [Share your feedback on our TTS rate limits](https://deepgram.typeform.com/tts-rate-limit) |
...
<Warning>
The [error](/reference/errors#429---too-many-requests) `429: Too Many Requests` is returned when your project has more concurrent requests than the rate limits allow. To learn more about this error please see our Documentation on [Errors](/reference/errors).
</Warning>