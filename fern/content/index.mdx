...
<div class="fern-card product-card p-6 center">
  <div class="col">
    ...
    - [API Reference](/reference/voice-agent-api/agent)
  </div>
...
<CardGroup cols={3}>
    <Card>
      <div class="product-card">
        ...
        - [Pre-recorded Audio](/speech-to-text/pre-recorded-audio/quickstart)
        - [Live Audio](/speech-to-text/live-audio/quickstart)
        - [Models and Languages](/speech-to-text/models-and-languages)
        - [API Reference](/reference/speech-to-text/listen)
      </div>
    </Card>
    <Card>
      <div class="product-card">
      ...
      <p class="t-muted">
        ...
        - [API Reference](/reference/text-to-speech/speak)
      </div>
    </Card>
    <Card>
      <div class="product-card">
      ...
      <p class="t-muted">
        ...
        - [API Reference](/reference/intelligence/text-read)
      </div>
    </Card>   
</CardGroup>
