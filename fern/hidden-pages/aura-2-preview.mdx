...
|----------------|-------------|----------|
| `model` | voice of the model<br />*Defaults to `aura-asteria-en` | `aura-2-andromeda-en`<br />*See [Voice Selection](<>) for all voices |
| `container` | container format of the audio<br />*Defaults to `wav` | `none`, `wav`, `ogg`<br />*Container options depend on encoding type |
| `encoding` | encoding of the audio<br />*Defaults to `mp3` | `linear16`, `alaw`, `mulaw`, `mp3`, `opus`, `flac`, `aac`<br />*See [Audio Output Formats](https://developers.deepgram.com/docs/aura-2-preview) below |
| `sample_rate` | sample rate of audio (Hz)<br />*Some encodings have fixed rates | *See [Audio Output Formats](https://developers.deepgram.com/docs/aura-2-preview) below |
| `bit_rate` | bitrate of audio (bps)<br />*Ranges vary by encoding | *See [Audio Output Formats](https://developers.deepgram.com/docs/aura-2-preview) below |
