...
<Warning>
You will need to migrate to the new [V1 Agent API](/reference/voice-agent-api/agent) to continue to use the Voice Agent API. Please refer to the [Voice Agent API Migration Guide](/docs/voice-agent-v1-migration) for more information.
</Warning>
