...
<div class="banner">
<div class="badge">[Introducing Aura-2, our text-to-speech built for enterprise use cases <span style={{ color: "#13EF95" }}>→</span>](https://developers.deepgram.com/docs/text-to-speech)</div>
