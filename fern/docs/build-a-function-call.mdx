...
<Warning>
This Guide is not updated yet to use the new [V1 Agent API](/reference/voice-agent-api/agent). Please refer to the [Voice Agent API Migration Guide](/docs/link-to-migration-guide) for more information on migrating to the new Voice Agent API.
</Warning>
