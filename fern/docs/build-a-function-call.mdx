...
<Warning>
This Guide is not updated yet to use the new ***Voice Agent API V1***. Please refer to the [Voice Agent API Migration Guide](/docs/voice-agent-v1-migration) for more information on migrating to the new Voice Agent API.
</Warning>
