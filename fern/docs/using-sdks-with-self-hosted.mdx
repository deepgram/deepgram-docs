...
Ensure that your request parameters are specifying a model that you have available on your self-hosted instance. For example, when you intend to serve requests through a formatted Nova-3 model, specify the following params:
