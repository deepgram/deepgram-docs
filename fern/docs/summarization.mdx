...
<span>
<img src="https://res.cloudinary.com/deepgram/image/upload/v1717523786/devex/codey-greeting_rekqe1.svg" alt="Deepgram API Playground"/>   Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=listen\&summarize=v2\&language=en\&model=nova-3)!
</span>
</div>
...
<Info>
  Summarization `V2` (`summarize=v2`) requires a minimum of greater than 50 words for summarization. For shorter inputs (<50 words), the original input will be returned. In this case, no tokens in or out are billed as summarization usage.
</Info>
