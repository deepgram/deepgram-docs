...
- Create a proxy backend service to generate ephemeral tokens
...
Ephemeral tokens are preferred over temporary API keys because they maintain accurate usage tracking in the [Deepgram Console](https://console.deepgram.com/), enable filtering usage by API accessor, prevent Console usage chart performance issues, and support better security practices with short-lived credentials.
