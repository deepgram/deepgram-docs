...
| `aura-2-sirio-es` | sirio | masculine | Adult | es-mx | Mexican | Calm, Professional, Comfortable, Empathetic, Baritone | Customer service | <audio id="sirio"  controls src="https://static.deepgram.com/examples/Sirio.wav"></audio> |
| `aura-2-nestor-es` | nestor | masculine | Adult | es-es | Peninsular | Calm, Professional, Approachable, Clear, Confident | Customer service | <audio id="nestor"  controls src="https://static.deepgram.com/examples/Nestor.wav"></audio> |
| `aura-2-carina-es` | carina | feminine | Adult | es-es | Peninsular | Professional, Raspy, Energetic, Breathy, Confident | Customer service, IVR | <audio id="carina"  controls src="https://static.deepgram.com/examples/Carina.wav"></audio> |
| `aura-2-celeste-es` | celeste | feminine | Young Adult | es-co | Colombian | Clear, Energetic, Positive, Friendly, Enthusiastic | Casual chat | <audio id="celeste"  controls src="https://static.deepgram.com/examples/Celeste.wav"></audio> |
| `aura-2-alvaro-es` | alvaro | masculine | Adult | es-es | Peninsular | Calm, Professional, Clear, Knowledgeable, Approachable | Informative | <audio id="alvaro"  controls src="https://static.deepgram.com/examples/Alvaro.wav"></audio> |
| `aura-2-diana-es` | diana | feminine | Adult | es-es | Peninsular | Professional, Confident, Expressive, Polite, Knowledgeable | Informative | <audio id="diana"  controls src="https://static.deepgram.com/examples/Diana.wav"></audio> |
| `aura-2-aquila-es` | aquila | masculine | Adult | es-419 | Latin American | Expressive, Enthusiastic, Confident, Casual, Comfortable | Storytelling, Advertising | <audio id="aquila"  controls src="https://static.deepgram.com/examples/Aquila.wav"></audio> |
| `aura-2-selena-es` | selena | feminine | Young Adult | es-419 | Latin American | Approachable, Casual, Friendly, Calm, Positive | Casual chat | <audio id="selena"  controls src="https://static.deepgram.com/examples/Selena.wav"></audio> |
| `aura-2-estrella-es` | estrella | feminine | Mature | es-mx | Mexican | Approachable, Natural, Calm, Comfortable, Expressive | Interview | <audio id="estrella"  controls src="https://static.deepgram.com/examples/Estrella.wav"></audio> |
| `aura-2-javier-es` | javier | masculine | Adult | es-mx | Latin American | Approachable, Professional, Friendly, Comfortable, Calm | Storytelling | <audio id="javier"  controls src="https://static.deepgram.com/examples/Javier.wav"></audio> |
