...
subtitle: Learn how to use Twilio with Deepgram Voice Agent API.
slug: docs/twilio-and-deepgram-voice-agent
---
...
You can set your Deepgram API key in the `sts_connect` function to run the server:
