...
<Info>
  If you need to create and distribute short-lived tokens for API requests, you can use the [token-based Auth API](/reference/ephemeral-auth-api/grant-token).
</Info>
