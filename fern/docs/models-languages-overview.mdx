...
| ---------------------------- | ------------------------------------------------ |
| `nova-3` or `nova-3-general` | [**Multilingual (English, Spanish, French, German, Hindi, Russian, Portuguese, Japanese, Italian, and Dutch): `multi`** ](/docs/multilingual-code-switching), <br />, English: `en`, `en-US` |
| `nova-3-medical`             | English: `en`, `en-US`                           |
