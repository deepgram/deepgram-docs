...
## API Deprecations
   - [`UpdateInstructions`](/voice-agent-update-instructions) is now deprecated
   - [`FunctionCallingMessage`](/voice-agent-function-calling-message) is now deprecated

 ## Experimental Features
   - [`AgentStartedSpeaking`](/voice-agent-agent-started-speaking) is now experimental
...
**Message Structure Changes:**
   ...
   - v1: Split into [`FunctionCallRequest`](/docs/voice-agent-function-call-request) and [`FunctionCallResponse`](/docs/voice-agent-function-call-response) types
