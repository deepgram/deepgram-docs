...
| `agent.speak.provider.endpoint` | Object | Required and must include url and headers |
| `agent.speak.provider.endpoint.url` | String | Your OpenAI API endpoint URL |
| `agent.speak.provider.endpoint.headers` | Object | Required headers for authentication |
...
| `agent.speak.provider.endpoint` | Object | Required and must include url and headers |
| `agent.speak.provider.endpoint.url` | String | Your Eleven Labs API endpoint URL |
| `agent.speak.provider.endpoint.headers` | Object | Required headers for authentication |
...
| `agent.speak.provider.endpoint` | Object | Required and must include url and headers |
| `agent.speak.provider.endpoint.url` | String | Your Cartesia API endpoint URL |
| `agent.speak.provider.endpoint.headers` | Object | Required headers for authentication |
