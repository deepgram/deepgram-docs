...
<Warning>
You will need to migrate to the new [V1 Agent API](/reference/voice-agent-api/agent) to continue to use the Voice Agent API. Please refer to the [Voice Agent API Migration Guide](/docs/link-to-migration-guide) for more information. **TODO: Need's link**
</Warning>
