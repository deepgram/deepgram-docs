...
* Choose your language setting based on your use case:
  ...
  - See our [supported languages](https://developers.deepgram.com/docs/models-languages-overview).
  - Important: Check the language documentation to ensure you're using the correct model (`nova-2` or `nova-3`) for your selected language.
