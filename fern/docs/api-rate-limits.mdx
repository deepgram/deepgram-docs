...
| [Aura-2](/docs/streaming-text-to-speech) | Pay as You Go: Up to 5 concurrent requests |
| [Aura-2](/docs/streaming-text-to-speech) | Growth:  Up to 5 concurrent requests |
...
| API                                               | Connection Limits              |
| :------------------------------------------------ | :----------------------------- |
| [Voice Agent API](/reference/build-a-voice-agent) | Starting at 50 concurrent connections |
