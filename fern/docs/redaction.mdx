...
For Deepgram's hosted API, we support Redaction for all available languages. For [self-hosted](/docs/self-hosted-introduction) deployments, we currently only support English language Redaction.
